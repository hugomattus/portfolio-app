              ...
              {app.images.results.some(img => img) && (
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginTop: '16px' }}>
                  ...
                  {app.images.results[2] && (() => {
                    ...
                    return <img srcSet={`${paths2.mobile} 600w, ${paths2.desktop} 1256w`} sizes="(max-width: 600px) 100vw, 100vw" src={paths2.desktop} alt={`${app.title} Result 3`} loading="lazy" style={{ width: '100%', height: 'auto', borderRadius: '8px' }} />;
                  })()}
