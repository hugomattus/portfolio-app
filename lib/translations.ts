  ...
  en: {
    ...
    projects: {
      ...
      Freela: {
        ...
        description: "A platform that connects clients with qualified freelancers to carry out projects in design, development and other creative areas.",
        client: "Freela",
        role: "Product Designer",
        service: "Product Design + Interaction",
        myRoleDescription: "I acted as a Product Designer leading the design of two main environments: the landing page for clients and the dashboard for freelancers, ensuring intuitive experiences aligned with the needs of each user.",
        myRoleIncluded: ["Research", "Wireframes", "User Flow", "Design System", "UI Design", "Prototyping", "Dashboard Design"],
        resultsDescription: "A complete platform that facilitates the connection between clients looking for creative services and qualified freelancers, with interfaces optimized for each type of user.",
        discoveryTitle: "Discovery",
        discoveryText: "We identified the opportunity to create a platform that would simplify the connection between clients and freelancers, solving pain points such as lack of trust, difficulty finding qualified professionals, and disorganized communication.",
        designTitle: "Design",
        designText: "We developed two distinct experiences: an attractive landing page for clients to discover and hire freelancers, and a powerful dashboard for freelancers to manage their projects, proposals and earnings.",
        finalTitle: "Final",
        finalText: "The result is a functional and visually attractive platform that serves as a bridge between supply and demand for creative services, facilitating business and professional relationships.",
        apps: [
          {
            title: "Landing Page",
            description: "The landing page was created for clients to discover qualified freelancers, view portfolios, read reviews and start projects in a simple and intuitive way.",
          },
          {
            title: "Freelancer Dashboard",
            description: "The dashboard provides freelancers with tools to manage proposals, track ongoing projects, receive payments and maintain a history of work performed.",
          },
        ],
      },
    },
